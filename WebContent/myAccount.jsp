...
<title>MagicBBS: My Account</title>
...
<jsp:include page="common/NavigationBar.jsp"></jsp:include>
	...
	<div class="submit-ad main-grid-border">
		<div class="container">
			<h2 class="head" style =" font-family: 'Comic Sans MS'">Your Account Information </h2>
		</div>
	</div>
<div class="panel panel-default">
 ...
 <div class="page-header"></div>
  ...
  <div class="submit-ad main-grid-border">
		...
		<div class="col-md-4">
			<img src="images/head/${user.portrait }" alt=""/>
		</div>
			          <h3>&nbsp; </h3>
			          <h5>&nbsp; </h5>
					 <h3 style =" font-family: 'Comic Sans MS'">User Name: ${user.account}</h3> <br>
					<h3 style =" font-family: 'Comic Sans MS'"> Nick Name: ${user.nickName}</h3> <br>
					 <h3 style =" font-family: 'Comic Sans MS'">Phone Number: ${user.phone }</h3><br>
			 		<h3 style =" font-family: 'Comic Sans MS'">Email: <a href="mailto@example.com" style =" font-family: 'Comic Sans MS'">${user.email }</a></h3>  <br>	 
		</c:forEach>
		<div class="clearfix"></div>
		<div class="new_people">
						   <a href="${pageContext.request.contextPath}/userServlet.action?md=changeInfo&un=${un}" >Change Your Personal Info</a>
		</div>
