...
<title>MagicBBS: All Posts</title>
...
<jsp:include page="common/NavigationBar.jsp"></jsp:include>
	...
	<div class="submit-ad main-grid-border">
		<div class="container">
			<h2 class="head" style =" font-family: 'Comic Sans MS'">Posts </h2>
		</div>
	</div>
...
<div class="panel panel-default">
 ...
 <div class="row">
		 <div class="col-lg-6">
    		<div class="input-group">
    		<form id="search" action = "${ pageContext.request.contextPath}/indexSelect?m=doSearch" class = "navbar-form narbar-left" role="search" method="post">
    		  <div class = "form-group">
    		   ...
    		   <div class = "form-group">
    		  		<h5 >Publisher</h5>
    		  		<input type="text" name = "person" id="person" class="form-control" placeholder="Search by Publisher...">&nbsp;&nbsp;&nbsp;
    		  </div>
    		  <div class = "form-group">
    		  		<h5>&nbsp;</h5>
